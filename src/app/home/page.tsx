    ...
    <AppShell user={user} partner={partner}>
      <PageContainer>
        ...
        <PageContent>
          ...
          {/* 3. System & Partnership Telemetry */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
            <Card className="border-border">
              ...
              <CardContent>
                <div className="text-base font-bold truncate">{user.displayName}</div>
            ...
            <Card className="border-border">
              ...
              <CardContent>
                {partner ? (
                  <>
                    <div className="text-base font-bold truncate">{partner.displayName}</div>
                    <p className="text-xs text-muted-foreground">@{partner.identifier}</p>
                  </>
                ) : (
                  <p className="text-xs text-amber-600 dark:text-amber-400">Not registered</p>
                )}
              </CardContent>
            </Card>
